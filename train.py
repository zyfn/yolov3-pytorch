...
def run():
    ...
    parser.add_argument("-m", "--model", type=str, default="config/yolov3 copy.cfg", help="Path to model definition file (.cfg)")
    ...
    print(f'flops:{flops/1e9*2},params:{params}')
    del input
    #########################加入wandb###################################
    ...
    for epoch in range(1, args.epochs+1):
        ...
        if epoch % args.evaluation_interval == 0:
            ...
            metrics_output,val_loss = _evaluate(
                model,
        ...
        ##########################################################################################
        wandb.log({"metric/precision": precision.mean(),'metric/recall':recall.mean(),'metric/mAP':AP.mean(),
                    "train/loss": loss,'train/iou_loss':float(loss_components[0]),"train/obj_loss": float(loss_components[1]),"train/class_loss": float(loss_components[2]),
